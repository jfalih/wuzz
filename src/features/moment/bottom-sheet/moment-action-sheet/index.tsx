...
interface MomentActionSheetProps {
  ref: React.ForwardedRef<BottomSheetModal>;
  actions?: typeof USER_ACTIONS;
}

export const MomentActionSheet = memo((props: MomentActionSheetProps) => {
...
MomentActionSheet.displayName = 'features/moment/moment-action-sheet';
export default MomentActionSheet;
