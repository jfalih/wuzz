...
import { Heart, Notification, Repeat, Send2 } from 'iconsax-react-native';

const UserDaily = memo(({ route, navigation }: ClipDetailType) => {
  ...
  return (
    <Fragment>
      ...
      >
        ...
        >
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut vel elit
          mauris. at vel elit mauris.
        </Text>
        <FlashList
          horizontal
